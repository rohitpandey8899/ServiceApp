...
public class install extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Install/Camera", 249, 0);
        RowItemSelectService service2 = new RowItemSelectService("Ip Camera/Installtion", 400, 0);
    ...
    private void init() {
        ...
        recyclerView = findViewById(R.id.cctviServiceRV);
        subTotalRL = findViewById(R.id.subTotalcctviServiceRL);
        subTotalTV = findViewById(R.id.subTotalcctviServiceTV);

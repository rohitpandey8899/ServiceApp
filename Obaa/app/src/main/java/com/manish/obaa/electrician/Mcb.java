...
public class Mcb extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Fuse(Replacement)", 99, 0);
        RowItemSelectService service2 = new RowItemSelectService("MCB(Installtion)", 149, 0);

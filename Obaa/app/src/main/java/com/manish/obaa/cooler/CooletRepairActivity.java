package com.manish.obaa.cooler;
...
public class CooletRepairActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coolet_repair);
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Grass (Khas) Replacement.", 299, 0);
        RowItemSelectService service2 = new RowItemSelectService("Water Pump Replacement.", 299, 0);
        RowItemSelectService service3 = new RowItemSelectService("Fan Replacement.", 149, 0);
        RowItemSelectService service4 = new RowItemSelectService("Other Repair.", 199, 0);
        RowItemSelectService service5 = new RowItemSelectService("Servicing & Cleaning.", 199, 0);
        RowItemSelectService service6 = new RowItemSelectService("Fan Motor Repair.", 499, 0);

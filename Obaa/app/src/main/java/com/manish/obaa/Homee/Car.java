...
public class Car extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Complete Cleaning", 1199, 0);
        RowItemSelectService service2 = new RowItemSelectService("Exterior Cleanining", 699, 0);
        RowItemSelectService service3 = new RowItemSelectService("Interior Cleaning", 799, 0);

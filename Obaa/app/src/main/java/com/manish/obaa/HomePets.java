...
public class HomePets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_pets);
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Book PestController", 149, 0);

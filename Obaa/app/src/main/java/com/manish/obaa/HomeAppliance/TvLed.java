...
public class TvLed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tv_led);
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Television", 00, 0);
        RowItemSelectService service2 = new RowItemSelectService("Led Lights", 00, 0);

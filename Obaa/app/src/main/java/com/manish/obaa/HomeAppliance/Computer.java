...
public class Computer extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Ro(Repair)", 00, 0);
        RowItemSelectService service2 = new RowItemSelectService("Ro(Installtion/Uninstalltion)", 00, 0);

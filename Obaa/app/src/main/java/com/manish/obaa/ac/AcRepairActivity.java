...
public class AcRepairActivity extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Window Ac Repair", 499, 0);
        RowItemSelectService service2 = new RowItemSelectService("Split Ac Repair", 599, 0);
    ...
    private void init() {
        ...
        recyclerView = findViewById(R.id.acRepairRV);
        subTotalRL = findViewById(R.id.subTotalAcServiceRL);
        subTotalTV = findViewById(R.id.subTotalAcRepairTV);
    }

...
public class Fan extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Fan(Repair)", 99, 0);
        RowItemSelectService service2 = new RowItemSelectService("Fan(Installtion/Uninstalltion)", 149, 0);

...
public class Switches extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("One Switch/Sockets(Installtion/Repair)", 49, 0);
        RowItemSelectService service2 = new RowItemSelectService("SwitchBoard Upto 6 Switches(Repair)", 99, 0);
        RowItemSelectService service3 = new RowItemSelectService("SwitchBoard Upto 6 Switches(Installtion)", 299, 0);

...
public class Homedeep extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homedeep);
        init();
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("1 BHK", 3299, 0);
        RowItemSelectService service2 = new RowItemSelectService("2 BHK", 3999, 0);
        RowItemSelectService service3 = new RowItemSelectService("3 BHK", 4999, 0);

        RowItemSelectService service4 = new RowItemSelectService("4 BHK", 5999, 0);
        RowItemSelectService service5 = new RowItemSelectService("5 BHK", 6999, 0);

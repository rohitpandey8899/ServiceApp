...
public class installtion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_installtion);
        init();
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Repair/Service", 249, 0);
        RowItemSelectService service2 = new RowItemSelectService("Normal Installtion ", 249, 0);
    ...
    private void init() {
        ...
        recyclerView = findViewById(R.id.cctvServiceRV);
        subTotalRL = findViewById(R.id.subTotalcctvServiceRL);
        subTotalTV = findViewById(R.id.subTotalcctvServiceTV);

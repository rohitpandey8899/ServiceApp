...
public class Uninstall extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Uninstall", 199, 0);
    ...
    private void init() {
        ...
        recyclerView = findViewById(R.id.cctvuServiceRV );
        subTotalRL = findViewById(R.id.subTotalcctvuServiceRL);
        subTotalTV = findViewById(R.id.subTotalcctvuServiceTV);

...
public class NumberSofa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number_sofa);
        init();
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("3 Sofa seats", 499, 0);
        RowItemSelectService service2 = new RowItemSelectService("4 Sofa seats", 599, 0);
        RowItemSelectService service3 = new RowItemSelectService("5 Sofa seats", 699, 0);

...
public class Fridge extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Fridge(Repair)", 00, 0);
        RowItemSelectService service2 = new RowItemSelectService("Fridge(Installtion/Uninstalltion)", 00, 0);

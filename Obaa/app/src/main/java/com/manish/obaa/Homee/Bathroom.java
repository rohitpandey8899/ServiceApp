...
public class Bathroom extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("1 Bathroom", 499, 0);
        RowItemSelectService service2 = new RowItemSelectService("2 Bathroom", 699, 0);
        RowItemSelectService service3 = new RowItemSelectService("3 Bathroom", 999, 0);
        RowItemSelectService service4 = new RowItemSelectService("4 Bathroom", 1299, 0);
        RowItemSelectService service5 = new RowItemSelectService("5 Bathroom", 1499, 0);

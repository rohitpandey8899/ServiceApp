...
public class AutoScrollViewpager extends ViewPager {
    ...
    private double swipeScrollFactor = 0.9;

    private Handler handler;
    private boolean  isAutoScroll  = false;
    private boolean  isStopByTouch = false;
    private float touchX = 0f, downX = 0f;
    private SliderDurationScroller scroller = null;
...
//    }
    ...
    private void init() {
        handler = new MyHandlers(AutoScrollViewpager.this);
    ...
    private void setViewPagerScroller() {
        try {
            ...
            scroller = new SliderDurationScroller(getContext(), (Interpolator)interpolatorField.get(null));
...
//    private ScrollerCustomDuration mScroller = null;
    ...
    private static class MyHandlers extends Handler {
        ...
        public MyHandlers(AutoScrollViewpager autoScrollViewPager) {

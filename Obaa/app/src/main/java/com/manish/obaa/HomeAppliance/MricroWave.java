...
public class MricroWave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mricro_wave);
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("MicroWave(Repair)", 00, 0);
        RowItemSelectService service2 = new RowItemSelectService("MicroWave(Installtion/Uninstalltion)", 00, 0);

...
public class Geyser extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Instant Geyser 1-5L(Installtion)", 399, 0);
        RowItemSelectService service2 = new RowItemSelectService("Storage Geyser 25L(Installtion)", 499, 0);
        RowItemSelectService service3 = new RowItemSelectService("Instant Gyser 1-5L(Uninstalltion)", 299, 0);
        RowItemSelectService service4 = new RowItemSelectService("Instant Geyser 1-5L(Installtion)", 399, 0);

...
import com.manish.obaa.Homee.Bathroom;
import com.manish.obaa.Homee.Carpet;
import com.manish.obaa.Homee.Homedeep;
...
public class HomeCleanning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_cleanning);
    ...
    private void setListener() {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouch(this, new RecyclerTouch.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (position == 0)
                {
                    startActivity(new Intent(HomeCleanning.this, Sofa.class));
                }else if (position == 1)
                {
                    startActivity(new Intent(HomeCleanning.this, Bathroom.class));
                }
                else if (position == 2)
                {
                    startActivity(new Intent(HomeCleanning.this, Carpet.class));
                }
                else if(position==3)
                {
                    startActivity(new Intent(HomeCleanning.this, Homedeep.class));
                }
    ...
    private void initRV() {
        ...
        final SweetAlertDialog progressDialog = new SweetAlertDialog(HomeCleanning.this, SweetAlertDialog.PROGRESS_TYPE);
        progressDialog.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
        progressDialog.setTitleText("Loading...");
        progressDialog.show();

        StringRequest request = new StringRequest(Request.Method.POST, Api.getcleaning, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    MainPlumberAdapter adapter = new MainPlumberAdapter(HomeCleanning.this, mainPlumberList);
        ...
        Volley.newRequestQueue(HomeCleanning.this).add(request);
    }
    private void init() {

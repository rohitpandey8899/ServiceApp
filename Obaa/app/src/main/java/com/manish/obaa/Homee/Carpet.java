...
public class Carpet extends AppCompatActivity {
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("Upto 25sq ft", 299, 0);
        RowItemSelectService service2 = new RowItemSelectService("25-50 sq-ft", 499, 0);
        RowItemSelectService service3 = new RowItemSelectService("50-100 sq-ft", 699, 0);
        RowItemSelectService service4 = new RowItemSelectService("100-150 sq-ft", 999, 0);

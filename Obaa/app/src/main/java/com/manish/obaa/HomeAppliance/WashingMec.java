package com.manish.obaa.HomeAppliance;
...
public class WashingMec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_mec);
    ...
    private void initRV() {
        ...
        RowItemSelectService service1 = new RowItemSelectService("WashingMachine(Repair)", 00, 0);
        RowItemSelectService service2 = new RowItemSelectService("WashingMachine(Installtion/Uninstalltion)", 00, 0);
